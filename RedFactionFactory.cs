...
{
    public class RedFactionFactory : IComponentFactory
    {
        private RedFactionComponent _instance;
        ...
        {
            get { return "Automates splitting and load removal for Red Faction."; }
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.RedFaction/master/"; }
        }
